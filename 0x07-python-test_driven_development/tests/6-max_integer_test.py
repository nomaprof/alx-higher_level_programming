...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_unordered_list(self):
        """Test for an unorderd list of integers"""
        unordered = [1, 2, 4, 3]
        self.assertEqual(max_integer(unordered), 4)

    def test_max_at_begginning(self):
        """Test for a list that has the max value as the first in the list"""
        max_at_beginning = [4, 3, 2, 1]
        self.assertEqual(max_integer(max_at_beginning), 4)

    def test_empty_list(self):
        """Test a list that is empty"""
        empty = []
    ...
    def test_string(self):
        """Test a for a list that has just one string"""
        string = "Brennan"
        self.assertEqual(max_integer(string), 'r')

    def test_list_of_strings(self):
        """Test a list that has several strings"""
